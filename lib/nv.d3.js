      ...
      if (align) {
        ...
        series
            .attr('transform', function(d, i) {
              ...
              return 'translate(' + xpos + 2  + ',' + ypos + ')';
            });
        container.style("height", ypos + 20);
        //position legend as far right as possible within the total width
...
/*
            l.sort(function comp(a, b) {
              return a[0] < b[0] ? -1 : (a[0] == b[0]) ? 0 : 1;
            });
            for (var i = 0; i < l.length - 1; i++) {
              if (l[i][0] == l[i][1]) {
                console.log("data looks like: ", i, l[i], l[i+1]);
              }
            }
*/

            return l.filter(function(pointArray, pointIndex) {
...
///*/
          ...
          pointPaths
              .attr('d', function(d, i) {
              //hack d3.geom.voronoi() issue
              if (d === undefined) {
                //console.log("BUG_NVD3: bug in nvd3, d undefined: ", pointPaths, i);
              }
